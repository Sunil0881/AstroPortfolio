  ...
  return (
    ...
    <div className=''>
      ...
      <div className='px-10 sm:block md:grid md:grid-cols-2  lg:grid lg:grid-cols-3 sm:px-40    md:px-7 md:gap-10 lg:gap-12 lg:px-5 '>
        <Card
          title="Pariharams"
          description="Get personalized pariharams from expert astrologers to solve problems and bring positive changes in life."
        ...
        <Card
          ...
          description="Find your perfect partner with our accurate astrology-based marriage matching and compatibility analysis."
          imgSrc={id}
        />
